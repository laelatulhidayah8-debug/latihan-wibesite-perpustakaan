...
- [Tugas 1: Eksplorasi Database](#tugas-1-eksplorasi-database)
- [Tugas 2: Desain Database Lengkap](#tugas-2-desain-database-lengkap)
...
```
60324009-LaelatulHidayah/
│
├── README.md
├── query_tugas.sql
├── 60324009_LaelatulHidayah_database.sql
│
└── images/
    ├── tugas1/
    │   ├── 01_total_buku.png
    │   ├── 02_nilai_inventaris.png
    │   ├── 03_rata_harga.png
    │   ├── 04_buku_termahal.png
    │   ├── 05_stok_terbanyak.png
    │   ├── 06_filter_programming.png
    │   ├── 07_filter_php_mysql.png
    │   ├── 08_filter_2024.png
    │   ├── 09_filter_stok.png
    │   ├── 10_filter_pengarang.png
    │   ├── 11_group_kategori.png
    │   ├── 12_avg_harga.png
    │   ├── 13_inventaris_terbesar.png
    │   ├── 14_update_harga.png
    │   ├── 15_update_stok.png
    │   ├── 16_restocking.png
    │   └── 17_top5_termahal.png
    │
    └── tugas2/
        ├── 01_struktur_kategori_buku.png
        ├── 02_struktur_penerbit.png
        ├── 03_struktur_rak.png
        ├── 04_struktur_buku.png
        ├── 05_struktur_anggota.png
        ├── 06_struktur_transaksi.png
        ├── 07_data_kategori_buku.png
        ├── 08_data_penerbit.png
        ├── 09_data_rak.png
        ├── 10_data_buku.png
        ├── 11_data_anggota.png
        ├── 12_data_transaksi.png
        ├── 13_join_buku_kategori_penerbit.png
        ├── 14_jumlah_per_kategori.png
        ├── 15_jumlah_per_penerbit.png
        └── 16_detail_lengkap.png
```
...
**1. Jalankan Tugas 2 (database baru):**
```
1. Buka phpMyAdmin → localhost/phpmyadmin
2. Klik tab "Import"
3. Pilih file: 60324009_LaelatulHidayah_database.sql
4. Klik "Go"
```

**2. Jalankan Tugas 1 (query eksplorasi):**
```
1. Klik database "perpustakaan" di panel kiri
2. Klik tab "SQL"
3. Copy-paste isi file query_tugas.sql
4. Klik "Go"
```
